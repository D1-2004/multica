...
type TaskContextForEnv struct {
	...
	// DispatchRuntimePrompt is trusted private instruction text generated by
	// Multica's PromptBuilder for this dispatch. It is never issue content.
	DispatchRuntimePrompt string
	// DispatchWorkflowPrompt is trusted private outbound instruction text.
	// Surface and mode decide which task workflow may consume it.
	DispatchWorkflowPrompt string
	DispatchSurfaceType    string
	DispatchOutboundMode   string
