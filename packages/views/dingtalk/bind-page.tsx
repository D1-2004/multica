...
// before redeeming because the redeemer's Multica identity is taken from
// the session (the token alone never proves who is binding — see
// dingtalk.BindingTokenService.RedeemAndBind). Mirrors SlackBindPage.
//
...
// with the bound installation. Each maps to distinct copy via
// dingtalk_bind in common.json.
