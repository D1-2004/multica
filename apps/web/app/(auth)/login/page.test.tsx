...
describe("LoginPage", () => {
  beforeEach(() => {
    ...
    // The page holds the login card behind a spinner until /api/config
    // resolves; mark the config as loaded so the form renders.
    act(() => {
  ...
  it("renders login form with email input and continue button", () => {
    ...
    expect(screen.getByText("FDE 工作台")).toBeInTheDocument();
