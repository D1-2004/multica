...
The installation and pull-request integration tables ship in migration `079_github_integration`; GitHub-backed agent source tables ship in `167_github_agent_source`. If you're upgrading an older deployment:
